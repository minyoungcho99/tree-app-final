...
var registerCallableModule = (_a = require('react-native').registerCallableModule) !== null && _a !== void 0 ? _a : BatchedBridge.registerCallableModule.bind(BatchedBridge);
/**
    ...
    var directEventCallbacks = useMemo(function () { return ({
        onShouldStartLoadWithRequest: function (event) {
            if (event.messagingModuleName === messagingModuleName) {
                var _ = event.messagingModuleName, rest = __rest(event, ["messagingModuleName"]);
